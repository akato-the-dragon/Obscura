...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.general_action = QAction(main_window)
        ...
        self.add_password_action = QAction(main_window)
        self.add_password_action.setObjectName(u"add_password_action")
        ...
        self.about_action = QAction(main_window)
        ...
        self.add_master_password_action = QAction(main_window)
        self.add_master_password_action.setObjectName(u"add_master_password_action")
        self.edit_master_password_action = QAction(main_window)
        self.edit_master_password_action.setObjectName(u"edit_master_password_action")
        self.remove_master_password_action = QAction(main_window)
        self.remove_master_password_action.setObjectName(u"remove_master_password_action")
        self.master_password_status_action = QAction(main_window)
        self.master_password_status_action.setObjectName(u"master_password_status_action")
        self.master_password_status_action.setEnabled(False)
        ...
        self.clear_passwords_list = QAction(main_window)
        self.clear_passwords_list.setObjectName(u"clear_passwords_list")
        ...
        self.passwords_menu.addAction(self.add_password_action)
        self.passwords_menu.addAction(self.clear_passwords_list)
        self.passwords_menu.addSeparator()
    ...
    def retranslateUi(self, main_window):
        ...
        self.general_action.setText(QCoreApplication.translate("main_window", u"\u0413\u043b\u0430\u0432\u043d\u0430\u044f", None))
        self.exit_action.setText(QCoreApplication.translate("main_window", u"\u0412\u044b\u0445\u043e\u0434", None))
        self.add_password_action.setText(QCoreApplication.translate("main_window", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c...", None))
        ...
        self.about_action.setText(QCoreApplication.translate("main_window", u"\u041e \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0435", None))
        self.action_version.setText(QCoreApplication.translate("main_window", u"<version>", None))
        self.add_master_password_action.setText(QCoreApplication.translate("main_window", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c...", None))
        self.edit_master_password_action.setText(QCoreApplication.translate("main_window", u"\u0418\u0437\u043c\u0435\u043d\u0438\u0442\u044c...", None))
        self.remove_master_password_action.setText(QCoreApplication.translate("main_window", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c", None))
        self.master_password_status_action.setText(QCoreApplication.translate("main_window", u"<master_status>", None))
        ...
        self.clear_passwords_list.setText(QCoreApplication.translate("main_window", u"\u0421\u0431\u0440\u043e\u0441 \u043f\u0430\u0440\u043e\u043b\u0435\u0439", None))
