...
class Ui_csv_import_popup_widget(object):
    def setupUi(self, csv_import_popup_widget):
        ...
        csv_import_popup_widget.resize(400, 302)
        self.csv_import_popup_layout = QVBoxLayout(csv_import_popup_widget)
        self.csv_import_popup_layout.setSpacing(15)
        self.csv_import_popup_layout.setObjectName(u"csv_import_popup_layout")
        self.csv_import_popup_layout.setContentsMargins(15, 15, 15, 10)
        ...
        self.csv_import_popup_layout.addLayout(self.csv_file_layout)
        ...
        self.column_remap_layout.setContentsMargins(45, 15, 45, 15)
        ...
        self.csv_import_popup_layout.addWidget(self.column_remap_group_box)
        ...
        self.csv_import_popup_layout.addLayout(self.buttons_layout)
