...
class Ui_add_password_popup_widget(object):
    def setupUi(self, add_password_popup_widget):
        ...
        self.password_line_edit = QLineEdit(add_password_popup_widget)
        ...
        self.error_label = ErrorLabel(add_password_popup_widget)
        ...
        self.add_password_popup_layout.addLayout(self.buttons_layout)


        self.retranslateUi(add_password_popup_widget)

        QMetaObject.connectSlotsByName(add_password_popup_widget)
    # setupUi
