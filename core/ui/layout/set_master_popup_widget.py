...
class Ui_add_master_popup_widget(object):
    def setupUi(self, add_master_popup_widget):
        ...
        self.repeat_password_label = QLabel(add_master_popup_widget)
        ...
        self.repeat_password_line_edit = QLineEdit(add_master_popup_widget)
        ...
        self.show_button = QPushButton(add_master_popup_widget)
        ...
        self.error_label = QLabel(add_master_popup_widget)
        self.error_label.setObjectName(u"error_label")

        self.add_master_popup_layout.addWidget(self.error_label)

        self.buttons_layout = QHBoxLayout()
        self.buttons_layout.setSpacing(10)
        self.buttons_layout.setObjectName(u"buttons_layout")
        self.buttons_layout.setContentsMargins(45, -1, 45, -1)
        self.set_button = QPushButton(add_master_popup_widget)
    ...
    def retranslateUi(self, add_master_popup_widget):
        self.title_label.setText(QCoreApplication.translate("add_master_popup_widget", u"\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c \u043c\u0430\u0441\u0442\u0435\u0440 \u043f\u0430\u0440\u043e\u043b\u044c", None))
        self.repeat_password_label.setText(QCoreApplication.translate("add_master_popup_widget", u"\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u0430\u0440\u043e\u043b\u044c:", None))
        self.password_label.setText(QCoreApplication.translate("add_master_popup_widget", u"\u041f\u0430\u0440\u043e\u043b\u044c:", None))
        self.show_button.setText("")
        self.error_label.setText(QCoreApplication.translate("add_master_popup_widget", u"<error>", None))
        self.set_button.setText(QCoreApplication.translate("add_master_popup_widget", u"\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c", None))
