...
class SetMasterPopup(CorePopup):
    ...
    def set_password(self) -> None:
        with open(self._master_path, "w+") as file:
            ...
            new_master = self._ui.password_line_edit.text()

            if current_master == old_master:
                if new_master == self._ui.repeat_password_line_edit.text():
    ...
    def show_hide_password(self) -> None:
        if self._ui.current_password_line_edit.echoMode() == QLineEdit.EchoMode.Password:
            self._ui.current_password_line_edit.setEchoMode(QLineEdit.EchoMode.Normal)
        else:
            self._ui.current_password_line_edit.setEchoMode(QLineEdit.EchoMode.Password)

    def cancel(self) -> None:
        self._ui.repeat_password_line_edit.clear()
        self._ui.repeat_password_line_edit.setEchoMode(QLineEdit.EchoMode.Password)
    ...
    def setup_ui(self) -> None:
        self._ui.set_button.clicked.connect(self.set_password)
